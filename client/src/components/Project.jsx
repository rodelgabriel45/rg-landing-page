...
const Project = ({ project }) => {
  return (
    <div className='border-b-4 shadow-lg border-teal-600'>
        ...
        <ul className='flex flex-col justify-center items-start'>
          <li className='md:text-2xl'>
            <div className='flex items-center gap-4'>
              <h2>{project?.title} - </h2>
              <span className='text-gray-300  sm:text-xl'>
                {project?.description}
              </span>
            </div>
            <h2 className='text-lg mt-2'>Technologies Used:</h2>
            <ul className='text-sm list-disc md:text-lg text-gray-300 px-7 mt-2'>
      ...
      <div>
        <ul className='flex flex-wrap gap-7 text-gray-300 md:text-lg my-10 justify-center list-disc'>
